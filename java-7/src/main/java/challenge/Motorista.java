...
public class Motorista {
    ...
    public static class MotoristaBuilder {
        ...
        // construtor vazio -> não passou nenhum parametro
        ...
        public MotoristaBuilder withIdade(int idade) {
        	// deveRetorarErroQuandoIdadeNegativa
        	if (idade < 0) {
        ...
        public MotoristaBuilder withPontos(int pontos) {
        	// deveRetorarErroQuandoPontosNegativos
        	if (pontos < 0) {
        		throw new IllegalArgumentException();
        	}
            this.pontos = pontos;
        ...
        public Motorista build() {
        	// teste 1 - deveRetornarErroQuandoMotoristaNaoTemHabilitacao
        	if (habilitacao == null || habilitacao.isBlank()) {
        		throw new NullPointerException();
        	}
        	
        	// teste 2 - deveRetornarErroQuandoMotoristaNaoTemNome

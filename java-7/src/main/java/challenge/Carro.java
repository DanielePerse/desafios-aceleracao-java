...
public class Carro {
    ...
    // construtor privado -> não posso instanciá-lo - Nesse projeto, somente instancio via builder
    // eu sṍ construo (encapsulamento) - não modifico (vide q não possui set, somente os getters)
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
        	// deveRetornarErroQuandoNaoTemPlaca
        	if (placa == null || placa.isBlank()) {
        		throw new NullPointerException();
        	}
        	
        	// deveRetornarErroQuandoNaoTemCor
        	if (cor == null) {
        		throw new NullPointerException();
        	}
